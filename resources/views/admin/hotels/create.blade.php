...
@section('script-footer')
    ...
    <script>
        function initMap() {
            ...
            var map = new google.maps.Map(document.getElementById('map-hotel'), {
...
{!! Form::open( array('route' => 'hotels.store', 'enctype' => 'multipart/form-data', 'class' => 'uk-form-horizontal uk-margin-small uk-grid') ) !!}
    <div class="uk-width-1-1@m">
        <div class="uk-margin">
            <label class="uk-form-label" for="name">ชื่อที่พัก<span class="uk-text-danger">*</span></label>
            <div class="uk-form-controls">
                <input class="uk-input {{ $errors->has('name') ? ' uk-form-danger' : '' }}" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="ชื่อที่พัก" required autofocus>
                @if ($errors->has('name'))
        ...
        <div class="uk-margin">
            <label class="uk-form-label" for="latlon">พิกัดที่พัก</label>
            <div class="uk-form-controls">
                <div id="map-hotel"></div>
                <input id="latlon" name="latlon" type="text" class="uk-input" placeholder="พิกัดที่พัก">
            </div>
        </div>
        <div class="uk-margin">
