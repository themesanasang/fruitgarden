...
@section('script-footer')
    ...
    Dropzone.options.realDropzone = {
        ...
        init:function() {
            ...
            $.get('gardens-getServerImages/'+gardenId, function(data) {    
            ...
            this.on("removedfile", function(file) {
                $.ajax({
                    type: 'POST',
                    url: 'delete',
                    data: {id: file.name, garden_id: gardenId},
                    dataType: 'html',
...
<h3>เพิ่มรูปภาพ สวนผลไม้</h3>
<hr>

<h3><span id="photoCounter"></span></h3>
<br />
{!! Form::open(['url' => 'gardens/uploads/store', 'class' => 'dropzone', 'files'=>true, 'id'=>'real-dropzone']) !!}
    <input type="hidden" id="garden_id" name="garden_id" value="{{ $id }}">
