...
$(function() {
    ...
    var gardens_table = $('#gardens-table').DataTable({
        processing: true,
        serverSide: true,
        destroy: true,
        "order": [[ 4, "desc" ]],
...
<table id="gardens-table" style="width:100%" class="uk-table uk-table-justify uk-table-small uk-table-striped uk-table-middle uk-table-hover uk-table-divider">
    <thead>
        <tr>
            <th>#</th>
            <th >ลำดับ</th>
