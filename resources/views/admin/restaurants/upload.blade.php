...
@section('script-footer')
    ...
    Dropzone.options.realDropzone = {
        ...
        init:function() {
            ...
            $.get('restaurants-getServerImages/'+rsrId, function(data) {    
...
<h3>เพิ่มรูปภาพ ร้านอาหาร</h3>
<hr>

<h3><span id="photoCounter"></span></h3>
<br />
{!! Form::open(['url' => 'restaurants/uploads/store', 'class' => 'dropzone', 'files'=>true, 'id'=>'real-dropzone']) !!}
    <input type="hidden" id="rsr_id" name="rsr_id" value="{{ $id }}">
