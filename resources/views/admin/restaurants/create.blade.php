...
@section('script-footer')
    ...
    <script>
        function initMap() {
            ...
            var map = new google.maps.Map(document.getElementById('map-rsr'), {
...
<h3>เพิ่ม ร้านอาหาร</h3>
<hr>

{!! Form::open( array('route' => 'restaurants.store', 'enctype' => 'multipart/form-data', 'class' => 'uk-form-horizontal uk-margin-small uk-grid') ) !!}
    <div class="uk-width-1-1@m">
        <div class="uk-margin">
            <label class="uk-form-label" for="name">ชื่อร้านอาหาร<span class="uk-text-danger">*</span></label>
            <div class="uk-form-controls">
                <input class="uk-input {{ $errors->has('name') ? ' uk-form-danger' : '' }}" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="ชื่อร้านอาหาร" required autofocus>
                @if ($errors->has('name'))
        ...
        <div class="uk-margin">
            <label class="uk-form-label" for="latlon">พิกัดร้านอาหาร</label>
            <div class="uk-form-controls">
                <div id="map-rsr"></div>
                <input id="latlon" name="latlon" type="text" class="uk-input" placeholder="พิกัดร้านอาหาร">
            </div>
        </div>
        <div class="uk-margin">
