...
@section('script-footer')
    ...
    Dropzone.options.realDropzone = {
        ...
        init:function() {
            ...
            $.get('events-getServerImages/'+eventId, function(data) {    
            ...
            this.on("removedfile", function(file) {
                $.ajax({
                    type: 'POST',
                    url: 'delete',
                    data: {id: file.name, event_id: eventId},
                    dataType: 'html',
...
<h3>เพิ่มรูปภาพ กิจกรรม</h3>
<hr>

<h3><span id="photoCounter"></span></h3>
<br />
{!! Form::open(['url' => 'events/uploads/store', 'class' => 'dropzone', 'files'=>true, 'id'=>'real-dropzone']) !!}
