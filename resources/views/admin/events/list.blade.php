...
<div uk-grid>
    <div class="uk-width-expand@m"><h3>จัดการ กิจกรรม</h3></div>
    <div class="uk-width-auto@m">
        <a href="{{ route('events.create') }}" class="uk-button uk-button-primary uk-width-auto@m"><span class="uk-margin-small-right" data-uk-icon="icon: plus"></span> เพิ่ม กิจกรรม</a>
    </div>
</div>
<hr>

<div class="uk-overflow-auto uk-margin-medium-top">
<table id="events-table" style="width:100%" class="uk-table uk-table-justify uk-table-small uk-table-striped uk-table-middle uk-table-hover uk-table-divider">
    <thead>
        <tr>
            <th>#</th>
            <th >ลำดับ</th>
            <th class="uk-table-expand">ชื่อสวนผลไม้</th>
            <th class="uk-table-expand">กิจกรรม</th>
